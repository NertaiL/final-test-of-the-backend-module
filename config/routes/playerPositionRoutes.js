...
import {
  ...
  getAllPlayerPositionByTeam,
  createPlayersPositionsByTeam,
} from "../../src/api/v1/controllers/playersPositionControllers.js";
...
router.post(
  "/equipments/:teamID/players",
  verifyTokenToAuthorize,
  createPlayersPositionsByTeam
);
